export class Usermodule {
    ...
    public comp_ssm:string;
    public comp_size:string;
    public comp_type:string;
 
    constructor(id:number,staff_name: string,staff_email:string,staff_password:string,staff_phonenum:string,comp_name:string,comp_ssm:string,comp_size:string,comp_type:string) {
      this.id = id;
